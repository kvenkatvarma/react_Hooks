   ...
   return(
      <div className="col-lg-6">
          <div className="card-body">
             <h5><i className="fa fa-arrow-right"></i> {prod.productName}</h5>
             <div>${prod.price.toFixed(2)}</div>
             <div className="mt-2 text-muted">#{prod.brand.brandName} #{prod.category.categoryName}</div>
             <div>
             ...
             <div className="float-right">
                 {prod.isOrdered ? (<span className="text-primary">Added to Cart</span>):(<button className="btn btn-sm btn-primary" onClick={()=>{
